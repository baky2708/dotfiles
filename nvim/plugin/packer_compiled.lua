...
_G.packer_plugins = {
  ...
  ["FixCursorHold.nvim"] = {
    loaded = true,
    path = "/home/baky/.local/share/nvim/site/pack/packer/start/FixCursorHold.nvim",
  ...
  ["telescope-media-files.nvim"] = {
    loaded = true,
    path = "/home/baky/.local/share/nvim/site/pack/packer/start/telescope-media-files.nvim",
