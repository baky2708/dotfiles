...
_G.packer_plugins = {
  ...
  ["cmp-cmdline"] = {
    loaded = true,
    path = "/home/baky/.local/share/nvim/site/pack/packer/start/cmp-cmdline",
  ...
  ["cmp-tabnine"] = {
    loaded = true,
    path = "/home/baky/.local/share/nvim/site/pack/packer/start/cmp-tabnine",
  ...
  ["lsp_signature.nvim"] = {
    loaded = true,
    path = "/home/baky/.local/share/nvim/site/pack/packer/start/lsp_signature.nvim",
